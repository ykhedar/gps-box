...
msg_types = {
    ...
    (CLASS_NAV, MSG_NAV_HPPOSLLH): UBloxDescriptor('NAV_HPPOSLLH',
                                                   '<B2BBIiiiibbbbII',
                                                   ['version', 'reserved1[2]', 'flags', 'iTOW', 'lon', 'lat', 'height',
                                                    'hMSL',
    ...
    # Need to correctly decode MSG_NAV_SVIN if want to use this message.
    ...
    # Need to correctly decode RTCM message if want to use it.
    ...
    (CLASS_AID, MSG_AID_DATA): UBloxDescriptor('AID_DATA', '', [])
}
